...
public class BSTClass {
	...
	{
        // case- 1:- root is null , return null
		if (root == null)
			return new BSTDeleteReturn(null,false);
		
        // case - 2:- root data is less than x , delete on right subtree
		if (root.data < x)
		{
        ...
        // case - 3:- root data is greater than x, delete on left subtree
		if (root.data > x)
		{
        ...
        // case- 4:- root data is same as x
		//Now, we handle the three sub cases where root.data=x
        
		//subcase 1 - Handling case where root has no children
		if (root.left == null && root.right == null)
			return new BSTDeleteReturn(null,true);
		
		//subcase 2.1 - Handling case where only left child is present
		if (root.left!=null && root.right==null)
			return new BSTDeleteReturn(root.left,true);
		
		//subcase 2.2 - Handling case where only right child is present
		if (root.right!=null && root.left==null)
			return new BSTDeleteReturn(root.right,true);
			
		//subcase 3 - Both children are present
